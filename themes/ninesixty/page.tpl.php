...
<body class="<?php print $body_classes; ?> show-grid">
  <div id="page" class="container-12 clear-block">
    ...
    <?php if ($search_box): ?>
      <div id="search-box" class="grid-6 prefix-6"><?php print $search_box; ?></div>
    <?php endif; ?>
    </div>
    ...
    <?php if ($mission): ?>
      <div id="mission" class="<?php print ns('grid-10', $header, 7); ?>">
        <?php print $mission; ?>
      </div>
    <?php endif; ?>

    <?php if ($header): ?>
      <div id="header-region" class="region <?php print ns('grid-10', $mission, 7); ?> clear-block">
        <?php print $header; ?>
      </div>
    <?php endif; ?>
    </div>
  ...
  <?php if ($left): ?>
    <div id="sidebar-left" class="column sidebar region grid-3 <?php print ns('pull-8', $right, 4); ?>">
      <?php print $left; ?>
    </div>
  <?php endif; ?>
