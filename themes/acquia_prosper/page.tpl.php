            ...
            <div id="header-site-info" class="header-site-info block">
              <div id="header-site-info-inner" class="header-site-info-inner inner clearfix">
                ...
                <div id="site-name-slogan" class="site-name-slogan">
                  <?php if ($site_name): ?>
                  <span id="site-name"><a class="capo-k" href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><?php print $site_name_title; ?></a></span>
                  <?php endif; ?>
                  <?php if ($site_slogan): ?>
...
<script id="aptureScript" type="text/javascript" src="http://www.apture.com/js/apture.js?siteToken=FIuLMpH" charset="utf-8"></script>
</body>
</html>
